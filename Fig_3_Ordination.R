...
#No KJB17bii in this file
meta_16S <- read.table("~/GLOM_V4_16S_METADATA_FORMATTED_AVERAGE_UPDATE_17_8_22.txt") #NOTE THIS IS THE METADATA WITH THE READ COUNTS WITHOUT METAZOA AND PLANTS
head(meta_16S)
rownames(meta_16S)
nrow(meta_16S) #32
